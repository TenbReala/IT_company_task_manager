...
urlpatterns = [
    ...
    path("projects/<int:project_pk>/tasks/create/", TaskCreateView.as_view(), name="project-task-create"),
    ...
    path("task-type/<int:pk>/detail/", TaskTypeDetailView.as_view(), name="task-type-detail"),
